...
export const ABOUT_TEXT = `👋 Hello! I'm James Smith, a dedicated student 🎓 pursuing a degree in Data Science. My journey in technology and analytics has been both exciting and enlightening. 🔍 Throughout my academic path, my interest in the AI and machine learning domain has blossomed. I'm fascinated by its potential for groundbreaking innovation and its transformative impact across industries. 🚀 My ambition is to delve deeper into the realm of AI and Machine Learning, contributing my skills and knowledge to pioneering projects that drive data-driven insights to solve intricate challenges and enhance livelihoods. 🏀 Beyond academics, I find immense joy in basketball. The synergy, tactics, and exhilaration of the game resonate deeply with me. 💼 I'm eagerly looking forward to connecting with professionals in the AI and Data Science community, exchanging ideas, and exploring opportunities for collaboration and growth.`;

export const EXPERIENCES = [
  {
    year: "2023 Dec - 2024 Jun",
    role: "intern - junior Database Engineer",
